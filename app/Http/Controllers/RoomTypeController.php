...
class RoomTypeController extends Controller
{
    ...
    {
        $data = RoomType::with('getTotalRooms')->findOrFail($id);
        $jumlahTersedia = $data->getTotalRooms->count(); // Sama dengan yang di landing page
    
        return view('customer.detail', compact('data', 'jumlahTersedia'));
    }
